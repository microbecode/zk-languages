...
#include "circom.hpp"
#include "calcwit.hpp"
void Multiply_0_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Multiply_0_run(uint ctx_index,Circom_CalcWit* ctx);
...
ctx->componentMemory[coffset].templateName = "Multiply";
...
Multiply_0_create(1,0,ctx,"main",0);
Multiply_0_run(0,ctx);
}
